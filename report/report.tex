...
\centering
    \begin{subfigure}[b]
    \includegraphics[scale=0.4]{images/calibration_orig.png}
    \caption{Image source de la caméra}
    \end{subfigure}

    \begin{subfigure}[b]
    \includegraphics[scale=0.4]{images/calibration_rectangle2.png}
    \caption{Filtre HSV}
    \end{subfigure}

    \begin{subfigure}[b]
    \includegraphics[scale=0.4]{images/calibration_rectangle.png}
    \caption{Rectangle approximés de l'écran}
    \end{subfigure}
\end{figure}
